...
class kegman_conf():
  ...
  def read_config(self):
    ...
    if os.path.isfile('/data/kegman.json'):
      ...
      self.config = {"cameraOffset":"0.06", "lastTrMode":"1", "battChargeMin":"85", "battChargeMax":"90", "wheelTouchSeconds":"600", "battPercOff":"25", "carVoltageMinEonShutdown":"11800", "brakeStoppingTarget":"0.25" }
      self.write_config(self.config)
    return self.config
